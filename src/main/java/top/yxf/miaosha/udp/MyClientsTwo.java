...
public class MyClientsTwo {
    public static final int MessageReceived = 0x99;
    private int scanPort = 2555;

    public MyClientsTwo(int scanPort) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ch.writeAndFlush(new DatagramPacket(
                    Unpooled.copiedBuffer("来自客户端:南无本师释迦牟尼佛 two", CharsetUtil.UTF_8),
