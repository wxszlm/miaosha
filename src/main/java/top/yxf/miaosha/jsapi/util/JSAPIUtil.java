...
public class JSAPIUtil {
    ...
    private static final Log LOG = LogFactory.getLog(JSAPIUtil.class);
    ...
    // 微信商户证书路径
    private static String CERT_PATH = "D:/demo/jsapi.p12";
    ...
    public static ResultEntity doTransfers(String appkey, String certPath, TransfersDTO model) {
        ...
        try {
            // 1.计算参数签名
            String paramStr = JSAPIUtil.createLinkString(model);
