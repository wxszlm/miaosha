...
public class DY {
    ...
    public static void testCheckbox() throws Exception {
        ...
        try {
            ...
            // 导出excel文件到指定目录
            File savefile = new File("D:\\01_excel_symbol");
            if (!savefile.exists()) {
                savefile.mkdirs();
            }
            String fileName = "D:\\checkbox_test001.xlsx";
    ...
    // 使用原生方法设置复选框是否选中
    private static void setCheckboxValue(Workbook workbook) {
